...
for cn in ['af', 'aki', 'ami', 'delirium', 'stroke', 'ssi']:
    ...
    for dataset in dataset_list:
        ...
        data_now = data[columns_base + columns_now]
        ...
        columns_to_scale = [col for col in X.columns if X[col].dtype in ['int64', 'float64'] and col not in columns_to_exclude and col not in columns_now]
        columns_to_encode = [col for col in X.columns if X[col].dtype in ['object'] and col not in columns_to_exclude and col not in columns_now]
        ...
        for name, model in models:
            ...
            results_filename = f'results_{cn}_{args[0]}_{name}_{dataset}_{age}_baseline_en_newstrategy.csv'
        ...
        print(f'Finished {cn} {dataset} {age} in {end_comp - start_comp}')
